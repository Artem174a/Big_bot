...
def register_user(dp: Dispatcher):
    ...
    dp.register_callback_query_handler(callback_services, lambda call: call.data[len(call.data) - 8:] == "services")
    dp.register_callback_query_handler(callback_services, lambda call: call.data[len(call.data) - 4:] == "serv")
